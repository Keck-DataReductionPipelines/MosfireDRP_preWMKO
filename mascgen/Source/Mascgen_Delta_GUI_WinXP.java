...
class Mascgen_Delta_GUI_WinXP extends JFrame {
    ...
    public Mascgen_Delta_GUI_WinXP() {
    	...
    	public void actionPerformed(ActionEvent e) {
            ...
            if (highObjRaHour - lowObjRaHour > 1) {
            	if ((highObjRaHour == 23) && (lowObjRaHour == 0)) {
    				...
    				JTextArea errorMsg = new JTextArea("The input object list spans more " +
...
//    		 Construct CSUFieldData from the input args array.
    ...
    class HelpActionListener implements ActionListener{
    	  ...
    	  public void actionPerformed(ActionEvent e){
    		  ...
    		  JTextArea helpLabel = new JTextArea("MASCGEN: MOSFIRE Automatic Slit " +
...
//        	 Rotate the objects in the CSU plane by the Position Angle.
    ...
    public static void main(String[] args) {
        Mascgen_Delta_GUI_WinXP window = new Mascgen_Delta_GUI_WinXP();
