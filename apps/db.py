...
def longslits():
    ...
    res = {
        'maskname': fdate,
        'band' : 'fixme',
        'flatnames': "['m%s_%%4.4i.fits' % i for i in range(a,b)]",
        'longnames': "['m%s_%%4.4i.fits' % i for i in range(c,d)]"
    }
    ...
    try:
        ...
        print("Could not open and write to {1}".format(fout))
